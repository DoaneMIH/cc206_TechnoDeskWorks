            ...
            Positioned(
              bottom: 1,
                ...
                child: CircleAvatar(backgroundColor: Colors.orange,
                    child: IconButton( icon: const Icon(Icons.mail, color: Colors.white),onPressed: () {}))
            ),
        ]),
      ),
            ...
            const Padding(padding: EdgeInsets.all(10),
             ...
             Padding(
              ...
              child: Container(
                ...
                child:Column(
                  children: [
                    const Padding(padding: EdgeInsets.fromLTRB(10,10,10,2),
                    child: Row(
                      children: [
                   ...
                   const Padding(
                      ...
                      child: SizedBox(
                        height: 80,
                        child: Text("We are looking for a skilled Graphic Designer to join our team. As a Graphic "
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          const Text("#graphicdesigner #design", style: TextStyle(
                            fontSize: 10,
                          ),),
                          const Spacer(flex:1),
